...
class EditNgo extends StatefulWidget {
  EditNgo({Key? key, required this.ngo}) : super(key: key);
  final Ngo ngo;

  @override
  State<EditNgo> createState() => _EditNgoState();
}

class _EditNgoState extends State<EditNgo> {
  ...
  void initState() {
    ...
    urlControlller.text = widget.ngo.urlWeb;
